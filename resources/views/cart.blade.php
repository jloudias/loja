                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="cart">
                            ...
                            <h1 class="cart-title">In Your Shopping Cart: <span class="c-primary">{{ ShoppingCart::countRows() }} items</span></h1>
                        ...
                        <form action="#" method="post" class="cart-main">
                            ...
                            <table class="shop_table cart">
                                ...
                                <tbody>
                                @foreach (ShoppingCart::all() as $pdt)
                                <tr class="cart_item">

                                    <td class="product-remove">
                                        <a href="{{ route('cart.delete',['id'=>$pdt->rawId()]) }}" class="product-del remove" title="Remove this item">
